...
public: //Moltes operacions maten la caché inecessariament, arreglar
    matriu(){};
    ...
    float r_determinant(){ //sense cap tipus d'optimitzacio. possibilitats: buscar files amb 0's, no fer crida recursiva si el nombre del centre de la creu és 0, no crear una nova matriu??(hard), no fer el check files=columnes usant immersió...
